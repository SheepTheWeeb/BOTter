...
class OtterKaartenCommand extends Command {
  ...
  constructor() {
    super("kaarten", ["rodekaarten", "redflags"], "Gives the last 10 received redflags.", 
      process.env.PREFIX + "kaarten <user>", true)
  }
  ...
  async execute(msg, args) {
    try {
      ...
      flags.forEach(flag => {
        ...
        flagString += `\n**${flag.updatedAt.toLocaleDateString("en-US")}** - From **${flag.giver.discord_tag}**, reason: ${flag.reason}. Double red? **${doublered}** ${disgustedEmoji}`;
      });
